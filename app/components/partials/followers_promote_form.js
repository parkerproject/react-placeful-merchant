  ...
  render() {
    ...
    return (
      <div className="box-typical box-typical-full-height" style={innerStyle.minHeight}>
        <h4 className="m-t-lg with-border text-center">Promote to followers <br />
          <small><mark> This is an exclusive special only for your followers </mark></small></h4>
          ...
          <div className="add-customers-screen-in">
            ...
            <form role="form" onSubmit={handleSubmit(this.handleFormSubmit)}>
              <div className="form-group">
                ...
                <p>
                  <span>Think of this as the tagline, the first thing your
                    followers will see in their notification inbox
                  </span>
                </p>
                <input
                  type="text"
...
FollowersPromoteForm.propTypes = {
